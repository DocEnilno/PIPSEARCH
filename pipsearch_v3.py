...
class PipSearchGUI:
    ...
    def install_selected_package(self):
        ...
        if not selected_package:  # If no package is selected, use the search entry
    ...
    def install_package(self, package_name):
        ...
        if version:
            package_name = f"{package_name}=={version}"  # Include the selected version
    ...
    def fetch_available_versions(self, package_name):
        # Use PyPI API to fetch available versions of the selected package
